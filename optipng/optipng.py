...
#                        dev@babyMRI.org
#
# Copyright 2022 Marcin Owsiany <porridge@redhat.com>
...
class OptiPNG(ChrisApp):
    ...
    """
    PACKAGE                 = __package__
    TITLE                   = 'OptiPNG: Advanced PNG Optimizer and Converter'
    ...
    def run(self, options):
        ...
        import subprocess
        import os
        absolute_inputs = [os.path.join(options.inputdir, e) for e in os.listdir(options.inputdir)]
        subprocess.check_call(['/usr/bin/optipng', '-dir', options.outputdir, '--'] + absolute_inputs)
